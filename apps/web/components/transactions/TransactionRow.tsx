...
export default function TransactionRow({
  ...
  return (
    <div className="grid grid-cols-[1fr_2fr_1.5fr_1fr_1fr] gap-4 px-6 py-4 border-b border-[#1a2d3d] hover:bg-[#ffffff04] transition-colors cursor-pointer items-center">
      {/* Date */}
