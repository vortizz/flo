...
export default function TransactionRow({
  ...
  return (
    <>
      {/* Mobile card */}
      <div className="flex items-center gap-3 px-4 py-4 border-b border-[#1a2d3d] hover:bg-[#ffffff04] transition-colors cursor-pointer md:hidden">
      ...
      {/* Desktop row */}
      <div className="hidden md:grid grid-cols-[1fr_2fr_1.5fr_1fr_1fr] gap-4 px-6 py-4 border-b border-[#1a2d3d] hover:bg-[#ffffff04] transition-colors cursor-pointer items-center">
        {/* Date */}
        <div className="flex flex-col">
          <span className="text-xs text-[#8b949e]">{formatTime(tx.date)}</span>
        </div>
